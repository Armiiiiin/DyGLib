                ...
                for i, agent_i in enumerate(agents):
                    for j, agent_j in enumerate(agents[i+1:], i+1):
                        ...
                        if dist < spatial_threshold:
                            ...
                            angle = np.arctan2(agent_j['y'] - agent_i['y'], agent_j['x'] - agent_i['x'])
                            rel_vx = agent_j['vx'] - agent_i['vx']
                            rel_vy = agent_j['vy'] - agent_i['vy']
                            ...
                            edge_feat = [
                                dist, angle,
                                agent_i['vx'], agent_i['vy'],
                                agent_j['vx'], agent_j['vy'],
                                rel_vx, rel_vy,
                                0.0, 0.0,  # removed view features
                                0.0, 0.0,
                                0.0,
...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = "/scratch/yiran/v2x/v2x_coop_map"
